...
#       Date: 28/02/2025
#       Version: 1.0.6
#       Description: Active Directory xRay Inventory & Details regarding the environment will be presented during the execution of the script. The log file will be created at: C:\AdxRay\ADXRay.log
#############################################################################
...
Add-Content $report ""
Add-Content $report "           <h1><a class='title' href='https://github.com/MrVillain09/ADxRay' target='_blank' rel='external'>Active Directory xRay Report</a></h1>" 
$button = @'
...
Add-Content $report "               <p class=disclaimer><strong>Disclaimer:</strong> This report was generated using the ADxRay Powershell Script. The information provided in this report is provided 'as-is' and is intended for information purposes only. The information present at the script is licensed 'as-is'. You bear the risk of using it. The Author give no express warranties, guarantees or conditions. You may have additional consumer rights under your local laws which this license cannot change. To the extent permitted under your local laws, the Author exclude the implied warranties of merchantability, fitness for a particular purpose and non-infringement. Any feedback or improvements feel free to email me at: <a href='mailto:mrvillain09@duck.com?Subject=ADxRay%20feedback' target='_top'>Mr. Villain</a></p>"
